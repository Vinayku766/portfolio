                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            num="1"
                            title="UI/UX Design"
                            desc="I Create UI/UX Interfaces with knowledge of colour theory, typography, By Creating wireframes and Learn from user experience how they like to use application modify according to users need."
                            data={[
                                "Prototype",
                                "Wireframe",
                                "User Experience",
                        ...
                        />
                            ...
                            desc="I am able to collabarate with other team members on a creative plan and creating and talk with clients and try to understand their problems or what they need, It makes me to fulfill their needs."
                            data={[
                                "Wireframe",
                                "Collabaration",
                                "Modern Design",
                        ...
                        <Service
                            ...
                            desc="I convert figma Ui/Ux designs into webpages with the help tools, write professional and easy to maintainable code and collabarate with other programmers, provide seo support"
                            data={[
                                "Prototype",
