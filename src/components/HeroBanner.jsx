...
import hiEmoji from "../assets/hi-vinay.png";
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>vinaykumaryadav766@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Vinay Kumar Yadav</span>
                    </div>
                    <div className="max-w-[510px] text-left">
                        I create and maintain modern front-end websites and applications.
                        Look forward to work with modern technologies and solve all your business problems.
                    </div>
                </motion.div>
                {/* INTRO END */}
                ...
                {/* NUMBER BLOCK START */}
                <motion.div
                    className="md:flex gap-2 relative z-10"
                    initial={{ y: 300, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                    transition={{ duration: 0.7, delay: 0.25 }}
                >
                ...
                {/* PERSON BLOCK START */}
                <motion.div
                    className="w-[300px] md:w-[340px] 2xl:w-[475px] absolute bottom-0 left-[75%] -translate-x-1/2"
                    initial={{ y: 200, x: "-50%" }}
                    animate={{ y: 0 }}
                    transition={{ duration: 0.5 }}
                >
                    ...
                    <div
                        className="absolute top-[200px] -right-6 2xl:top-[240px] 2xl:-right-10 w-[100px] h-[100px] rounded-full bg-white/[0.7] flex flex-col justify-center items-center gap-2 backdrop-blur-sm cursor-pointer transition-transform scale-[0.65] md:scale-100 active:scale-[0.55] md:active:scale-90"
                        onClick={() => scrollTo("contact")}
                    >
                        <img
