        ...
        <div id="work" className="mt-10 relative">
            ...
            <Div className="mb-10">
                ...
                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-[#CCCCCC] text-center">
                  Projects shows where you stand currently in your journey I have build many projects, few of them here.
                </div>
            </Div>
            {/* SECTION HEADING END */}
                    ...
                    return (
                        ...
                        >
                            <div className="bg-black rounded-[20px] aspect-video overflow-hidden">
                                <img
                                    src={item.image}
                                    className="h-[100%] transition-transform hover:-translate-y-[25%] hover:duration-2500 ease-linear"
                                />
                            </div>
